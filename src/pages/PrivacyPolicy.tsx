  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-3xl font-medium mb-8 text-gray-900">سياسة الخصوصية</h1>
        
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-6 text-right" dir="rtl">
          <section>
            <h2 className="text-xl font-medium mb-3 text-gray-800">مقدمة</h2>
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-gray-800">المعلومات التي نجمعها</h2>
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-gray-800">كيفية استخدام المعلومات</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-gray-800">تسجيل الدخول عبر أطراف ثالثة</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-gray-800">حذف البيانات</h2>
            <p className="text-gray-600 leading-relaxed">
